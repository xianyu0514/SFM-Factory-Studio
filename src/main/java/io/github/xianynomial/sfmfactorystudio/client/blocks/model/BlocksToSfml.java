...
public final class BlocksToSfml {
    ...
    private static String writeLabelAccess(LabelAccess a, boolean energyOnly) {
        ...
        if (labels.isEmpty()) {
            ...
            sb.append(quoteLabelIfNeeded(new Loc("gui.sfmfactorystudio.model.gen.no_label_set", "未设置标签").getString()));
...
public static String quoteLabelIfNeeded(String label) {
        ...
        if (label == null || label.isBlank()) label = new Loc("gui.sfmfactorystudio.model.gen.no_label_set", "未设置标签").getString();
