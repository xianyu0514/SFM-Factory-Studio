    ...
    public static final class ResourceRef {
        ...
        public static ResourceRef parse(String sfml) {
            ...
            switch (parts.length) {
                ...
                default -> throw new IllegalArgumentException(new Loc("gui.sfmfactorystudio.model.err.res_segments", "资源名称最多只能有四段").getString());
        ...
        public ResourceRef withResourcePart(String value) {
            ...
            if (parts.length == 1) {
                ...
                throw new IllegalArgumentException(new Loc("gui.sfmfactorystudio.model.err.res_name_only", "这里只填写资源名称，例如 water 或 minecraft:water").getString());
    ...
    public record SlotRange(long first, long last) {
        ...
        public SlotRange {
            ...
            if (first < 0 || last < first) {
                ...
                throw new IllegalArgumentException(new Loc("gui.sfmfactorystudio.model.err.slot_range", "槽位必须是非负数，且范围终点不能小于起点").getString());
        ...
        public static SlotRange parseLenient(String text, int total) {
            ...
            throw new IllegalArgumentException(new Loc("gui.sfmfactorystudio.model.err.slot_digit", "槽位请输入数字，如 3 或 3-10").getString());
        ...
        public static SlotRange parse(String text) {
            ...
            if (!value.matches("[0-9]+(?:-[0-9]+)?")) {
                ...
                throw new IllegalArgumentException(new Loc("gui.sfmfactorystudio.model.err.slot_format", "槽位应写成 0 或 0-5").getString());
