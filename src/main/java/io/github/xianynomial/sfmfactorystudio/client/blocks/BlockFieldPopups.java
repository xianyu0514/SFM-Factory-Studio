...
abstract class Popup {
    ...
    public static class TextPopup extends Popup {
        ...
        public void render(GuiGraphics g, Font font, int mx, int my) {
            ...
            if (confirmLabel != null) {
                ...
                drawAction(g, font, x + w - 104, by, 48, new Loc("gui.sfmfactorystudio.blocks.popup.cancel", "取消").getString(), mx, my, false);
    ...
    public static class NumberPopup extends Popup {
        ...
        public void render(GuiGraphics g, Font font, int mx, int my) {
            ...
            drawButton(g, font, x + w - 94, y + 42, 42, new Loc("gui.sfmfactorystudio.blocks.popup.cancel", "取消").getString(), mx, my, false);

            drawButton(g, font, x + w - 48, y + 42, 42, new Loc("gui.sfmfactorystudio.blocks.popup.ok", "确定").getString(), mx, my, true);
    ...
    public static class LabelPopup extends Popup {
        ...
        public void render(GuiGraphics g, Font font, int mx, int my) {
            ...
            if (filtered.isEmpty()) {
                ...
                String empty = new Loc("gui.sfmfactorystudio.blocks.popup.no_labels", "暂无标签，可在下方新建").getString();
