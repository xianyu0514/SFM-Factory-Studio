...
public final class SfmlToBlocks {
    ...
    public static ResultWithFilter parseWithFilter(String text) {
        ...
        if (result.program().triggers.get(0).body.isEmpty()) {
            ...
            return new ResultWithFilter(null, List.of(new Loc("gui.sfmfactorystudio.model.parse.no_filter", "没有识别到资源标签条件").getString()));
        ...
        return new ResultWithFilter(null, List.of(new Loc("gui.sfmfactorystudio.model.parse.with_required", "筛选条件必须以 with 或 without 开头").getString()));
