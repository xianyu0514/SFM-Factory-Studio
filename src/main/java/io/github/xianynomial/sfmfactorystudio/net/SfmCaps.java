...
/**
 * Capabilities advertised by this addon's server side, pushed once at login
 * via {@link SfmCapabilitiesPayload}. Defaults to everything OFF so
 * vanilla-SFM servers simply never unlock the gated features.
 */
public final class SfmCaps {
    ...
    /** True only when the connected server runs this addon with NBT matching active. */
